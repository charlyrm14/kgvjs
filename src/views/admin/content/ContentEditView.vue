                        ...
                        <div class="flex justify-between items-start md:items-center">
                            <h2 
                                class="uppercase text-gray-600 dark:text-slate-400 text-lg md:text-2xl"> 
                                    Editar {{ contentStore?.contentDetail?.title ?? 'Desconocido' }} 
                            </h2>
                            <p 
                                class="flex justify-start items-center gap-x-1 mt-1"
                                :class="typeContentColor(contentStore?.contentDetail?.content_type_id)">
                                <svg 
                                ...
                                </svg> {{ contentStore?.contentDetail?.content_type?.title }}
                            </p>
                        </div>
                        <div>
                                        ...
                                        <div class="dark:text-slate-300">
                                            <p class="uppercase font-light"> 
                                                Visibilidad 
                                                    <span 
                                                        class="block text-xs"
                                                        :class="contentStore?.contentDetail?.active  === 1 ? 'text-green-500' : 'dark:text-slate-400'"> {{ contentStore?.contentDetail?.active  === 1 ? 'Publicado' : 'Borrador' }} </span>
                                            </p>
                                        </div>
                                        <button 
                                            type="button" 
                                            ...
                                            :class="contentStore?.contentDetail?.active  === 1 ? 'bg-green-500' : 'bg-slate-400'"
                                            @click="togglestatuscontent">
                                                ...
                                                :class="contentStore?.contentDetail?.active  === 1 ? 'translate-x-6' : 'translate-x-1'"></span>
                                        </button>
                                    </div>
