<script setup>
    ...
    onMounted(async() => {
        await userStore.fetchFeaturedStudents()
    })
    ...
    <section class="px-6 md:px-12 lg:px-16 py-8 md:py-10">
        ...
        <div class="text-center mt-2 mb-8">
            ...
            <p class="text-gray-600 dark:text-gray-400 text-sm sm:text-base">
                En <span class="text-blue-500"> King Dreams </span> reconocemos a quienes sobresalen por su esfuerzo, constancia y compromiso.
            </p>
        </div>
        <div 
            v-if="userStore?.featuredStudents?.length > 0"
            class="grid grid-cols-1 md:grid-cols-4 py-4 gap-y-4 md:gap-x-4 md:gap-y-0 mt-4">
                <div 
                    v-for="user in userStore?.featuredStudents"
                    :key="user.id"
                    class="bg-blue-100 rounded-lg shadow-md border border-blue-200 dark:border-none relative">
                        <div class="px-4 py-2 flex justify-between items-center">
                            ...
                            <button
                                ...
                                class="bg-blue-200 rounded-full p-1 hover:opacity-75 cursor-pointer">
                                    <svg 
                                        ...
                                        class="size-6 text-blue-500">
                                            <path 
                                                ...
                                                :d="showDetail ? 'm4.5 15.75 7.5-7.5 7.5 7.5' : 'm19.5 8.25-7.5 7.5-7.5-7.5' " />
                                    </svg>
                            </button>
                        </div>
                        <div 
        ...
        <div 
            ...
            class="flex justify-center items-center">
                <p class="text-pink-500"> Aquí podrás ver a los estudiantes más destacados en King Dreams, cuando el administrador los registre :( </p>
        </div>
    </section>
</template>
