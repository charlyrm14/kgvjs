        ...
        <div class="bg-white dark:bg-slate-800 rounded-2xl shadow-xl w-[90%] max-w-md sm:max-w-lg md:max-w-2xl lg:max-w-2xl xl:max-w-2xl p-6 mx-4">
            ...
            <div class="my-5">
                <div class="flex justify-center items-center">
                    <div class="bg-gray-200 dark:bg-slate-700 flex justify-between items-center rounded-lg p-1.5">
                        <button
                            @click="contentType = 0"
                            class="flex justify-center items-center gap-x-2 px-4 py-1.5 uppercase cursor-pointer"
                        ...
                        <button
                            ...
                            class="flex items-center gap-x-2 px-4 py-1.5 uppercase cursor-pointer">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-5">
